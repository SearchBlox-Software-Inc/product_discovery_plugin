...
function SearchUI() {
   ...
   function doSearch(params) {
      ...
      let queryForTitle = `SearchBlox | Product Discovery Results: ${params.query || ''}`;
      ...
      getSBResponse(params)
         ...
         .finally(() => {
            ...
            document.title = `SearchBlox | Product Discovery Results: ${formatQueryForTitle(queryForTitle)}`;
            setLoading(false);
         });
   }
