...
export async function sendChatTestMessage(data) {
   return axios.post(`${PLUGIN_DOMAIN}/ui/v1/chatbot/chat-test`, data);
}


// vote actions on the received  chat response
export async function voteChatMessage(data, signal) {
   return axios.post(`${CHATBOT_DOMAIN}/ui/v1/chatbot/action`, data, { signal });
}
